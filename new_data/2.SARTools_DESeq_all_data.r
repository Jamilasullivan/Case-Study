...
workDir <- "C:/Users/jamsu/OneDrive - Cardiff University/University/Masters/Big Data Biology/Modules/BIT103. Case Study/NEW DATA"      # working directory for the R session

projectName <- "SiglecF_neutrophils"                         # name of the project
author <- "Jamila"                                # author of the statistical analysis/report

targetFile <- "Metadata2.txt"                           # path to the design/target file
rawDir <- "featurecounts.csv"                             # path to the directory containing raw counts files
