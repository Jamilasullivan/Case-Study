...
write.csv(filtered, "DESeq_filtered_deseq_results_siglecf.csv") # saves filtered DESeq results as a csv
...
write.csv(normalised_counts, "DESeq_normalised_counts_siglecf.csv") # saves normalised counts as a csv
