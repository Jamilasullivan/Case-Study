...
workDir <- "C:/Users/jamsu/OneDrive - Cardiff University/University/Masters/Big Data Biology/Modules/BIT103. Case Study/DATA/Case-Study_R-Project/DESeq_CD"      # working directory for the R session

projectName <- "Pan_CD"                         # name of the project
author <- "Jamila"                                # author of the statistical analysis/report

targetFile <- "CD_metadata.txt"                           # path to the design/target file
